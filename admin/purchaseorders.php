    ...
    <body>
        ...
        <div class="content" style="margin-top:10px">
            ...
            <div class="mainbar">
                ...
                <!-- Page heading -->
                <div class="page-head">
                    <h2 class="pull-left"><i class="fa fa-user"></i> Purchase Orders</h2>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="widget">
                                    <div class="widget-head">
                                        <div class="pull-left"> Purchase Orders
                                            <a href="purchaseorder.php" class="btn btn-info" >Add New Purchase Orders</a>
                                        </div>
                                                ...
                                                <div class="table-responsive">
                                                    <table cellpadding="0" cellspacing="0" border="0" id="data-table" width="100%">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $query = mysqli_query($con, "select * from purchaseorder order by PurchaseOrderID")or die(mysqli_error($con));
                                                            while ($row = mysqli_fetch_array($query)) {
                                                                ...
                                                                <tr> <td><?php echo $id; ?></td>
                                                                    ...
                                                                    <td><?php
                                                                        $query3 = mysqli_query($con, "select * from supplier where supplier_id=" . $SupplierID)or die(mysqli_error($con));
