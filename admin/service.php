                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 padding-top-10">
                                        <?php
                                        $query2 = "SELECT * from category WHERE Description = 'Other Services'";
                                        $result2 = mysqli_query($con, $query2);
                                        ...
                                        echo '<input type="text" class="form-control" name="categorydesc3" id="categorydesc3" value="' . $category_desc . '" readonly />';
                                    ...
                                    <div class="col-md-3 padding-top-10">
                                        <label class="control-label" for="HexInput3"> 
                                            &nbsp&nbsp<input onclick="showhide3();" type="checkbox" name="data3" id="HexInput3"  value="Other Services"> Select Category
                                            &nbsp&nbsp&nbsp&nbsp&nbsp</label></div>
                                    <div class="col-md-4 padding-top-5"></div>
                                            ...
                                            <div class="page-tables">
                                                ...
                                                <div class="table-responsive">
                                                    <table cellpadding="0" cellspacing="0" border="0" id="data-table" width="100%">
                                                        ...
                                                        <?php
                                                        $query = mysqli_query($con, "SELECT * FROM Service where Category_ID = '1'");
                                                        if (mysqli_num_rows($query) > 0) {
                                                            while ($row = mysqli_fetch_assoc($query)) {
                                                                ?>
                                                                <tr>
                                                                    <td align="center"><input type="checkbox" name="checked_id[]" class="checkbox" value="<?php echo $row['ServiceID']; ?>"/></td>        
                                            ...
                                            <div class="page-tables">
                                                ...
                                                <div class="table-responsive">
                                                    <table cellpadding="0" cellspacing="0" border="0" id="data-table" width="100%">
                                                        ...
                                                        <?php
                                                        $query = mysqli_query($con, "SELECT * FROM Service where Category_ID = '2'");
                                                        if (mysqli_num_rows($query) > 0) {
                                                            while ($row = mysqli_fetch_assoc($query)) {
                                                                ?>
                                                                <tr>
                                                                    <td align="center"><input type="checkbox" name="checked_id2[]" class="checkbox" value="<?php echo $row['ServiceID']; ?>"/></td>        
                                                                    <td><?php echo $row['ServiceID']; ?></td>
                                                                    <td><?php echo $row['ServiceType']; ?></td>
                                                                    <td><?php echo $row['Cost']; ?></td>
                                            ...
                                            <div class="page-tables">
                                                ...
                                                <div class="table-responsive">
                                                    <table cellpadding="0" cellspacing="0" border="0" id="data-table" width="100%">
                                                        ...
                                                        <?php
                                                        $query = mysqli_query($con, "SELECT * FROM Service where Category_ID = '3'");
                                                        if (mysqli_num_rows($query) > 0) {
                                                            $cnt = 1;
                                                            while ($row = mysqli_fetch_assoc($query)) {
                                                                ?>
                                                                <tr>
                                                                    <td align="center"><input type="checkbox" name="checked_id3[]" class="checkbox" value="<?php echo $row['ServiceID']; ?>"/></td>        
                                                                    <td><?php echo $row['ServiceID']; ?></td>
                                                                    <td><?php echo $row['ServiceType']; ?></td>
                                                                    <td><?php echo $row['Cost']; ?></td>
...
//					</script>";
        ...
        <script language="JavaScript" type="text/javascript">
            ...
            window.location.href = "dashboard.php";
                    ...
                    var div = document.getElementById                                      ('msgser                              vice');
