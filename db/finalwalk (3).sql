...
--
-- Host: 127.0.0.1
-- Generation Time: May 19, 2018 at 09:36 AM
...
(3, 'Gref Sanders', 'skratch56@gmail.com', 'Cape Town', '1900', '0820431141');
...
INSERT INTO `employee` (`employee_id`, `name`, `surname`, `email`, `city`, `postalcode`, `phonenumber`, `employeetype`, `jobtitle`, `password`) VALUES
(1, 'Josh', 'Josh', 'josh@gmail.com', 'Nkomazi', '1342', '082013333', 'value=manager', 'CEO', '123'),
(2, 'mphile', 'mphile', 'mphile@gmail.com', 'Nkomazi', '1342', '0820431141', 'value=Permanent', 'HR', '123'),
(3, 'Zine', 'Zine', 'zine@gmail.com', 'Vanderbijlpark', '1900', '0824411411', 'value=value=Contract', 'Admin', '123');
...
(7, '2018-05-19', '0', 'Quote', '2018-05-19', '2018-05-19', 'Pending', 3, 1);
...
--
-- Dumping data for table `quote/service`
--

INSERT INTO `quote/service` (`ServiceID`, `QuotationID`, `Date`) VALUES
(5, 1, '18-05-19'),
(5, 3, '2018-05-19'),
(6, 1, '2018-05-19'),
(6, 3, '2018-05-19'),
...
INSERT INTO `service` (`ServiceID`, `ServiceType`, `Cost`, `Category_ID`) VALUES
(5, 'Tar Roads', '500.00', 1),
(6, 'Pavements', '500.00', 1),
(7, 'Bridges', '500.00', 1),
(8, 'Office Park', '500.00', 2),
(9, 'Schools', '500.00', 2),
(10, 'Appartments', '500.00', 2),
(11, 'Shopping Complex', '500.00', 2),
(12, 'Residential Complex', '500.00', 2),
(13, 'RDPs', '500.00', 2),
(14, 'Hospitals', '500.00', 2),
(15, 'Car Shed', '500.00', 2),
(16, 'Plumbing', '500.00', 3),
(17, 'Painting', '500.00', 3);
